...
private:
    ...
    const QString SERVER_GET_URL = "http://192.168.2.104:8081/api/atm"; // 웹서버의 API 엔드포인트
    const QString SERVER_PUT_URL = "http://192.168.2.104:8081/api/atm";     // 예금 출금 송금시 필요함.
    const QString SERVER_POST_URL = "http://192.168.2.104:8081/api/atm"; // 센서 로그 올리기
